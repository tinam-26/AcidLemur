...
draw_text_transformed(100, 650, cat_food_string, 1, 1, 0)
draw_text_transformed(250, 650, health_string, 1, 1, 0)
...
draw_healthbar(400, 650, 600, 675, percent_health, c_white, c_red, c_lime, 0, true, false);
// test